...
urlpatterns  = [
	...
	path('gigs/<str:username>/<str:gig_title>/<str:share>', gig_View_View.as_view(), name='gig_share_view'),
	...
	path("buyer",buyer_dashboard_view.as_view(),name = 'buyer'),
 	path("requirements/paypal/<str:offer_id>/<str:pay_id>/<str:pay_email>/<str:trans_id>/<str:pay_status>/<str:base_price>/<str:total_price>/<str:service_fee>/<str:pay_to>/<str:extra_gig>/<str:credits_used>",requirements_p_view.as_view(),name = 'requirements'),
 	...
 	path("requirements/credit/<str:offer_id>/<str:base_price>/<str:total_price>/<str:fees>/<str:extra_gigs>/<str:used_credits>/<str:pay_to>/<str:pay_by>",requirements_c_view.as_view(),name = 'requirements'),
	...
	path("user/<str:username>/create_gig/<str:gigid>/NEW",create_gig_view.as_view(),name = 'create_gig'),
    ...
    path("post_credit_transaction/",views.post_credit_transaction_view,name = 'post_credit_transaction'),
    ...
    path("get_index_data/",views.get_index_data_view,name = 'get_index_data'),
    path("get_affiliate_data/",views.get_affiliate_data_view,name = 'get_affiliate_data'),
    path("get_earn_data/",views.get_earn_data_view,name = 'get_earn_data'),
    path("get_freelancer_data/",views.get_freelancer_data_view,name = 'get_freelancer_data'),
    path("get_all_page_data/",views.get_all_page_data_view,name = 'get_all_page_data'),
    ...
    path("post_user_notification/",views.post_user_notification_view,name = 'post_user_notification'),
    path("post_view_gig_offer/",views.post_view_gig_offer_view,name = 'post_view_gig_offer'),
]
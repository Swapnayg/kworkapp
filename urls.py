...
urlpatterns  = [
	...
	path("buyer",buyer_dashboard_view.as_view(),name = 'buyer'),
 	path("requirements/paypal/<str:offer_id>/<str:pay_id>/<str:pay_email>/<str:trans_id>/<str:pay_status>/<str:base_price>/<str:total_price>/<str:service_fee>/<str:pay_to>",requirements_p_view.as_view(),name = 'requirements'),

        ...
        <td class="o_re o_bg-white o_px o_pt" align="center">
          ...
          <div class="o_col o_col-3 o_col-full" style="margin-top:25px; margin-bottom: 25px;">
            <div class="o_px-xs o_sans o_text o_text-light o_left o_xs-center">
              <h4 class="o_heading o_text-dark"><strong>"""+gig_title+"""</strong></h4>

              <p class="o_text-xs o_mb-xs">
                Quantity: """+order_qty+"""<br>
                Duration: """+order_duration+"""<br>
                Seller: """+seller_username+"""<br>
                <strong class="selected-element">Amount: </strong>"""+order_amount+"""
                <br>
              </p>
    ...
    <tbody>
      <tr>
        <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center">
          <h4 class="o_heading o_text-dark o_mb-xs"></h4><h4 class="o_heading o_text-dark o_mb-xs selected-element" data-color="Dark" data-size="Heading 4" data-min="10" data-max="26">Hello, """+seller_username+"""</h4>
          <p class="o_mb-md">You just received an order from """+buyer_username+""". Deliver as soon as possible to release your payment.</p>
          <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tbody>
              <tr>
    ...
    <tr>
      <td class="o_bg-light o_px-xs" align="center" style="background-color: #e8f2e8;padding-left: 8px;padding-right: 8px;">
        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;"><h4 class="o_heading o_text-dark o_mb-xs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 8px;color: #242b3d;font-size: 18px;line-height: 23px;">Dear """+seller_username+""" </h4>
                <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">You just received an revision request from """+buyer_username+""" for your order. </p>
                <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
          ...
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                ...
                <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">"""+sender_username+""" Has Sent Extension Request To Your Order. </p>
                <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
          ...
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;"><table cellspacing="0" cellpadding="0" border="0" role="presentation">
                ...
                <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">We are sorry for the inconvenience, but your Extension was declined because """+reason+""". Please correct and """+sender_username+""", have an conversation and come to one point.</p>
                <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
          ...
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;"><table cellspacing="0" cellpadding="0" border="0" role="presentation">
                ...
                <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">Congratulations, your request has been approved by the """+ sender_username+ """.</p>
                <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
                      <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #2E5DC5;border-radius: 4px;"><a class="o_text-white" href="https://letworkbedone.com/user/"""+receiver_username+"""/manage_orders/"""+order_number+"""/activities" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">See More Details</a></td>
          ...
          <tbody>
            <tr>
              <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;"><table cellspacing="0" cellpadding="0" border="0" role="presentation">
                ...
                <p style="margin-top: 0px;margin-bottom: 0px;">You just received an tip from the """+buyer_username+"""</p></td>
              </tr>
            </tbody>
          </table>
        </td>
        ...
        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
          <tbody>
            <tr>
              ...
              <h6 class="o_heading o_text-dark" style="font-family: Helvetica, Arial, sans-serif;font-size: 12px;font-weight: bold;margin-top: 0px;margin-bottom: 2px;color: #242b3d;font-size: 24px;line-height: 25px;">Gig Title: """+ gig_title+"""</h6>
                
                <p class="o_mb" style="margin-top: 0px;font-size: 14px;margin-bottom: 2px;"><strong>Category:</strong> """+ gig_category+""" <br>
                </p>
                <p style="margin-top: 0px;margin-bottom: 0px;font-size: 14px;"><strong>Buyer:</strong>"""+ buyer_username+"""<br>
                </p>
    ...
    <tbody>
      <tr>
        <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 24px;padding-bottom: 24px;">
          <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tbody>
              <tr>
                ...
                <p class="o_text-xxs o_text-light" style="font-size: 12px;line-height: 19px;color: #82899a;margin-top: 0px;margin-bottom: 0px;">"""+ message_date +"""</p>
          ...
          <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">"""+ message +""" </p>
        </td>
      </tr>
    </tbody>
  </table>
                ...
                <tbody>
                  <tr>
                    <td class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #2E5DC5;border-radius: 4px;">
                      <a class="o_text-white" href="https://letworkbedone.com/inbox/"""+receiver_username+"""" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Reply to Message</a>
                    </td>
                  </tr>
                </tbody>
              </table>

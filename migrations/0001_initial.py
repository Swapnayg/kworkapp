    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_type', models.CharField(blank=True, choices=[('Buyer', 'Buyer'), ('Seller', 'Seller')], default='', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, default=datetime.datetime(2022, 9, 21, 21, 7, 6, 579020), null=True)),
                ('updated_at', models.DateTimeField(blank=True, default=datetime.datetime(2022, 9, 21, 21, 7, 6, 579020), null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lng_Name', models.CharField(blank=True, max_length=300, null=True)),
                ('lng_slug', models.CharField(blank=True, max_length=300, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, default=datetime.datetime(2022, 9, 21, 21, 7, 6, 580020), null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='main_category', to='kworkapp.categories')),
                ('sub_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_category', to='kworkapp.subcategories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lang_prof', models.CharField(blank=True, choices=[('Basic', 'Basic'), ('Fluent', 'Fluent'), ('Conversational', 'Conversational')], default='Basic', max_length=200, null=True)),
                ('language_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kworkapp.languages')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={

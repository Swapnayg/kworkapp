...
! function(e, i) {
    "function" == typeof define && define.amd ? define(["tooltipster"], function(e) {
        return i(e)
    }) : "object" == typeof exports ? module.exports = i(require("tooltipster")) : i(jQuery)
}(this, function(e) {
    return e.tooltipster._plugin({
        ...
        instance: {
            __init: function(i) {
                var t = this;
                t.__instance = i, t.__maxSize, t.__namespace = "tooltipster-scrollableTip-" + Math.round(1e6 * Math.random()), t.__instance._on("positionTest." + t.__namespace, function(e) {
                    "document" == e.container && e.takeTest(!1)
                }), t.__instance._on("positionTested." + t.__namespace, function(i) {
                    var n = !1;
                    if (e.each(i.results, function(e, i) {
                        ...
                        e.each(i.results, function(e, t) {
                            if (a[e] = {
                                    height: Math.min(i.helper.geo.available.window[t.side].height - t.distance.vertical, i.helper.geo.window.size.height),
                                    width: Math.min(i.helper.geo.available.window[t.side].width - t.distance.horizontal, i.helper.geo.window.size.width)
                    ...
                    })) : t.__instance.option("interactive") || e(i.tooltip).css("pointer-events", "")
                })
            },
            __destroy: function() {
